...
1. We auto-magically parse the different type of `Members` from the [/\_members/](/_members) folder. Insert or modify `.markdown` files as described in the [/\_members/README.md](/_members/README.md) file. Advanced: the parsing is achieved via the [jekyll collections](https://jekyllrb.com/docs/collections/) mechanism, implemented [here](https://github.com/corolab/corolab.github.io/blob/0a890309da44616f980fbd5f600e505c09014d54/_config.yml#L39-L49) and [here](https://github.com/corolab/corolab.github.io/blob/0a890309da44616f980fbd5f600e505c09014d54/_includes/members.html#L42-L215).
